...
Patterns for managing LLM agents across extended multi-context-window workflows. This is optional reference content for when you need to design long-running agent systems.
...
**Auto-Compact**: Triggers at ~95% context capacity. Agent Code summarizes history, preserving architectural decisions and unresolved bugs. Manually trigger with `/compact` at logical breakpoints.

**Token Budget Awareness**: Some agents receive updates on remaining context after tool calls. Enables better task persistence and strategy adjustment.
...
- [Anthropic agent best practices](https://www.anthropic.com/engineering/agent-code-best-practices)
- [Effective context engineering](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents)
- [agent-flow](https://github.com/ruvnet/agent-flow) - Multi-agent orchestration
- [continuous-agent](https://github.com/AnandChowdhary/continuous-agent) - CI/CD loop pattern
